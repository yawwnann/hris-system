...
<template>
  <Dialog v-model:open="isOpen">
    <DialogContent class="sm:max-w-xl w-[90vw] max-h-[90vh] overflow-y-auto bg-white dark:bg-zinc-950 border-gray-200 dark:border-zinc-800 rounded-xl p-0">
      <div class="p-6">
        <DialogHeader class="mb-6">
          <DialogTitle class="text-gray-900 dark:text-gray-100 text-xl font-bold">{{ isEditing ? 'Ubah Karyawan' : 'Tambah Karyawan Baru' }}</DialogTitle>
          <DialogDescription class="text-gray-500 dark:text-gray-400 mt-1.5">
        ...
        <form @submit.prevent="saveEmployee" class="space-y-6">
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-1.5">
                ...
                <Input v-model="form.password" type="password" :required="!isEditing" placeholder="******" class="bg-gray-50 dark:bg-zinc-900 border-gray-200 dark:border-zinc-800 text-gray-900 dark:text-gray-100 focus:border-orange-500 focus:ring-orange-500/20" />
              ...
              <div class="space-y-1.5">
                ...
                <Input v-model="form.phone" placeholder="+62 8..." class="bg-gray-50 dark:bg-zinc-900 border-gray-200 dark:border-zinc-800 text-gray-900 dark:text-gray-100 focus:border-orange-500 focus:ring-orange-500/20" />
              </div>
            </div>
          </div>
          ...
          <DialogFooter class="pt-6 mt-6 border-t border-gray-100 dark:border-zinc-800 flex justify-end gap-3 sm:justify-end">
            <Button type="button" variant="outline" @click="isOpen = false" class="bg-white dark:bg-zinc-900 border-gray-200 dark:border-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-zinc-800">Batal</Button>
            <Button type="submit" :disabled="loading" class="bg-orange-600 hover:bg-orange-700 text-white min-w-[140px] shadow-sm shadow-orange-500/30">
